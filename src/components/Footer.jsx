    ...
    >
      <div className="max-w-[1184px] px-4 w-full flex flex-row gap-25 justify-between items-center">
        <div className="flex flex-col justify-between h-40">
          <div className="flex flex-row gap-2 select-none">
            <img
              ...
              alt="logo"
            />
            <h3 className="font-dm font-bold text-3xl text-accent">
              SmartNotes
            </h3>
          </div>
          <div className="relative">
            <input
              className="bg-accent h-12 w-[290px] border-1 border-secondary-200 rounded-lg text-[#333333] text-sm leading-[150%] font-dm pl-4 pr-15"
              type="email"
        ...
        <div className="flex flex-row max-w-[762px] justify-between w-full flex-wrap">
          <div className="flex flex-col gap-0.5">
            <h5 className="font-dm font-bold text-accent leading-[150%] text-lg pb-0.5">
              Product
            </h5>
            <a
              className="font-dm text-base leading-[150%] text-primary-500 transition transition-color hover:text-secondary-200"
              href="#"
            >
              About
            </a>
          ...
          <div className="flex flex-col gap-0.5">
            <h5 className="font-dm font-bold text-accent leading-[150%] text-lg pb-1">
              Company
            </h5>
            <a
              className="font-dm text-base leading-[150%] text-primary-500 transition transition-color hover:text-secondary-200"
      ...
      <div className="bg-secondary-200 w-full">
        <div className="flex flex-row h-19 justify-between items-center max-w-[1152px]  px-2 mx-auto">
          <p className="font-dm text-primary-400 text-sm leading-[150%]">
