...
function AccordionItem({ item, openQuestion, setOpenQuestion }) {
  ...
  return (
    <div>
      ...
      >
        <p className="font-dm text-xl leading-[140%] text-accent font-bold">
          {question}
        </p>
        <img
      ...
      >
        <div className="flex flex-row bg-accent border-1 border-secondary-200/60 rounded-2xl gap-6.5 p-7.5">
          <div className="flex w-full gap-5 flex-col">
            <p className="font-dm text-xl leading-[140%] text-primary-400 font-bold">
              {answerHeading}
            </p>
            <p className="font-dm text-base text-[#333333] leading-[150%] text-justify">
              {answer}
            </p>
          </div>
          <img
