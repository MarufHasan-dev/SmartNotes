...
function PricingTile({
  ...
  return (
    <div
      className={`${bg} font-[DM_Sans] text-accent flex flex-col gap-6 py-10 px-8 rounded-[10px] border-2 border-secondary-200`}
    >
      <div className="flex gap-2 items-center">
        <img
          className="border-[1px] border-secondary-200/60 rounded-[4px] p-[2px] w-[25px] h-[25px]"
          src={planIcon}
          alt="plan icon"
        />
      ...
      <div>
        <button
          className={`w-[294px] h-[60px] flex justify-center items-center gap-x-2 text-primary-400 rounded-lg cursor-pointer hover:scale-105 transition-transform ease-in-out duration-200 border-[1px] border-secondary-200 ${
            darkMode
