  ...
  return (
    <section className="py-24">
      <div className="text-center">
        ...
        <p className="font-dm leading-[150%] text-primary-500/70 w-[410px] text-center inline-block">
          With lots of unique blocks, you can easily build a page without
          coding. Build your next landing page.
        </p>
      </div>
      <div className="flex gap-3.5 justify-center py-10 h-[113px] items-center">
        <p className="font-dm text-accent text-[18px] leading-[150%]">
          Monthly
        </p>
        ...
        <p className="font-dm text-primary-500 text-[18px] leading-[150%]">
          Yearly
        </p>
        <span className="font-dm text-primary-400 text-[14px] leading-[150%] py-[2.5px] px-4 bg-linear-66 to-secondary-100 from-secondary-300 rounded-[13px]">
          Save 25%
        </span>
      </div>
