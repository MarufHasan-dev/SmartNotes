  ...
  return (
    <section className="hero flex justify-between gap-4 max-w-[1440px] h-[590px] px-[152px] py-[54px]">
      <div className="max-w-[636px] flex justify-center flex-col">
        <h1 className="font-bold text-accent text-[59px] font-dm leading-[106%] tracking-[-3px] mb-4">
        ...
        <p className="text-primary-500 font-dm leading-[150%] mb-[50px]">
          Experience the power of smart note-taking and transform the way you
          work today.
        </p>
        <div className="relative w-[434px]">
          <input
            className="bg-accent text-[#333333] font-dm max-w-[434px] w-full h-[68px] rounded-lg py-[28px] px-6 placeholder:text-primary-300"
            type="email"
            name="email"
            id="email"
